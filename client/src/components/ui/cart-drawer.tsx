...
export default function CartDrawer() {
  const { isOpen, items, toggleCart, updateQuantity, removeItem, calculateTotal } = useCart();
        ...
        <div className="p-6">
          ...
          <div className="space-y-4 mb-6">
            {items.length === 0 ? (
              ...
              items.map((item) => (
                <div key={item.id} className="flex items-center border-b border-neutral-200 pb-4">
                  <img 
                    src={item.image} 
                    alt={item.name} 
